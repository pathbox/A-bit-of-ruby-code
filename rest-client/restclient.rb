...
module RestClient
  ...
  def self.get(url, headers={}, &block)
    Request.execute(:method => :get, :url => url, :headers => headers, &blcok)
  end

  def self.post(url, payload, headers={}, &block)
    Request.excute(:method => :patch, :url => url, :payload => payload, :headers => headers, &block)
  end
